    ...
    <table dir="" style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img class="mail-img-2"
                    @if ($data['icon']) src="{{ asset('storage/app/public/email_template/') }}/{{ $data['icon'] ?? '' }}"
                @else
                src='{{ asset('/public/assets/admin/img/email-template-img.png') }}' @endif
                    id="iconViewer" alt="">
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                @else
                    <img style="width:120px;display:block;margin:10px auto"
                        src="{{ asset('/public/assets/admin/img/favicon.png') }}" alt="public/img">
                @endif
                <span class="privacy">
                ...
                <span class="copyright" id="mail-copyright">
                    {{ $copyright_text ?? translate('Copyright_2023_ruchiCart._All_right_reserved') }}
                </span>
            </td>
        </tr>
    </table>
