...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="ruchiCart Software Installation" aria-valuenow="60"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('Provide your database information.') }}
                <a href="https://docs.ruchicart.com/docs-ruchiCart/admin-panel/install-on-server" target="_blank">
