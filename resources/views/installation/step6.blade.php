        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="p-4 rounded mb-4 text-center">
                ...
                <ul class="list-group mar-no mar-top bord-no">
                    ...
                    <li class="list-group-item">{{ translate('3rd Party APIs<') }}
                    <li>
                </ul>
            </div>

            <div class="text-center">
                <a href="{{ env('APP_URL') }}/admin/auth/login" target="_blank"
                    class="btn btn-dark px-sm-5">{{ translate('Admin Panel') }}</a>
                <a href="{{ env('APP_URL') }}/branch/auth/login" target="_blank"
                    class="btn btn-secondary px-sm-5">{{ translate('Branch Panel') }}</a>
            </div>
        </div>
    </div>
@endsection
