...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="ruchiCart Software Installation" aria-valuenow="40"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('Provide your') }} <strong>{{ translate('username of codecanyon') }}</strong> &
                <strong>{{ translate('purchase code') }}</strong></p>
