...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ translate('ruchiCart Software Installation') }}</h2>
        <h6 class="fw-normal">{{ translate('Please proceed step by step with proper data according to instructions') }}</h6>
    </div>

    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="ruchiCart Software Installation" aria-valuenow="90"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('These information will be used to create') }}
                <strong>{{ translate('admin credential') }}</strong>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="admin_f_name" required
                                        placeholder="Ex: John">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="last-name" class="form-control" name="admin_l_name" required
                                        placeholder="Ex: Doe">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="number-input-wrap">
                                        ...
                                        <input type="tel" id="phone" class="form-control" name="admin_phone"
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="email" id="email" class="form-control" name="admin_email"
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="password"
                                            name="admin_password" class="form-control" placeholder="Ex: 8+ character"
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" name="confirm_password" autocomplete="new-password"
                                            id="confirm_password" class="form-control" placeholder="Ex: 8+ character"
                                            minlength="8" required>
                                        <div class="togglePassword">
                                            <img src="{{ asset('public/assets/installation') }}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
