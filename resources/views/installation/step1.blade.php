...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="ruchiCart Software Installation" aria-valuenow="20"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.ruchicart.com/docs-ruchiCart/intro" class="d-flex align-items-center gap-1"
                    target="_blank">
            ...
            <div class="text-center">
                ...
                @if (
                    ...
                    <a href="{{ route('step2', ['token' => bcrypt('step_2')]) }}"
                        class="btn btn-dark px-sm-5">{{ translate('Proceed Next') }} </a>
                @endif
            </div>
        </div>
    </div>
