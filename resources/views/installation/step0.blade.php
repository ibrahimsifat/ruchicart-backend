...
@section('content')
    ...
    <div class="pb-2 px-2 px-sm-5 mx-xl-4">
        <div class="progress cursor-pointer" role="progressbar" aria-label="ruchiCart Software Installation" aria-valuenow="0"
    ...
    <div class="card mt-4">
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            <p class="text-center mb-4 top-info-text">
                {{ translate('Before starting the installation process please collect this
            ...
            <div class="bg-light p-4 rounded mb-4">
                <div class="d-flex justify-content-between gap-1 align-items-center flex-wrap mb-4 pb-sm-3">
                    ...
                    <a href="https://docs.ruchicart.com/docs-ruchiCart/admin-panel/install-on-server"
