...
@section('content')
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                <p class="mb-0">
                                    ...
                                    @if ($selectedMaintenanceDuration['maintenance_duration'] != 'until_change')
                                        {{ translate('from ') }}<strong>{{ $startDate->format('m/d/Y, h:i A') }}</strong> to
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-2">
                            ...
                            <label class="switcher ml-auto mb-0">
                                <input type="checkbox"
                                    class="switcher_input @if (!$config) maintenance-mode-show @endif"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $restaurant_name }}" name="restaurant_name"
                                    class="form-control" placeholder="{{ translate('Ex: ABC Company') }}">
                            </div>
                        </div>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $decimal_point_settings }}"
                                    name="decimal_point_settings" class="form-control"
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $footer_text }}" name="footer_text"
                                    class="form-control" placeholder="{{ translate('Ex: Copyright@ruchiCart.com') }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="self_pickup"
                                        {{ $sp == null || $sp == 0 ? '' : 'checked' }} id="self_pickup_btn">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input readonly class="switcher_input" type="checkbox" name="delivery"
                                        {{ $del == null || $del == 0 ? '' : 'checked' }} id="delivery_btn">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="toggle_veg_non_veg"
                                        {{ $vnv_status == null || $vnv_status == 0 ? '' : 'checked' }}
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="dm_self_registration"
                                        {{ $dm_status == null || $dm_status == 0 ? '' : 'checked' }}
                                        id="dm_self_registration">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="partial_payment_combine_with" class="form-control">
                                    <option value="COD"
                                        {{ isset($combine_with) && $combine_with == 'COD' ? 'selected' : '' }}>COD</option>
                                    <option value="digital_payment"
                                        {{ isset($combine_with) && $combine_with == 'digital_payment' ? 'selected' : '' }}>
                                        Digital Payment</option>
                                    <option value="offline_payment"
                                        {{ isset($combine_with) && $combine_with == 'offline_payment' ? 'selected' : '' }}>
                                        Offline Payment</option>
                                    <option value="all"
                                        {{ isset($combine_with) && $combine_with == 'all' ? 'selected' : '' }}>All</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-control d-flex flex-column-2">
                                        <div class="custom-radio d-flex gap-2 align-items-center">
                                            <input type="radio" class="" value="manual"
                                                name="admin_order_notification_type" id="admin_order_notification_type1"
                    ...
                    <div class="">
                        ...
                        <div class="d-flex justify-content-center my-4 gap-3">
                            ...
                            <button class="btn btn-danger"
                                data-dismiss="modal">{{ translate('Ok, Turn Off') }}</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal for Checking -->
    <div class="modal fade" id="modalCheckedModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="text-center">
                        ...
                        <div class="my-4">
                            <button class="btn btn-primary"
                                data-dismiss="modal">{{ translate('Yes, Turn On') }}</button>
                        </div>
                    </div>
                </div>
            </div>
