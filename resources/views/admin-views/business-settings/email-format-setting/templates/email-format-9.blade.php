    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                <h2 class="mb-3" id="mail-title">{{ $data['title'] ?? translate('Main_Title_or_Subject_of_the_Mail') }}
                </h2>
                            ...
                            <td class="p-10">
                                <span class="d-block text-center">
                                    ...
                                    <img class="mb-2 mail-img-2"
                                        onerror="this.src='{{ asset('storage/app/public/business/' . $restaurant_logo) }}'"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="max-width:130px">
                                                ...
                                                <span class="d-block">4517 Washington Ave. Manchester, Kentucky
                                                    39495</span>
                                            </td>
                                        </tr>
                                        <td colspan="2">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-left p-2 px-3">
                                                            1. The school of life - emotional baggage tote bag - canvas
                                                            tote bag (navy) x 1
                                                        </td>
        ...
        <tr>
            <td>
                <span class="privacy">
                    <a href="#" id="privacy-check"
                        style="{{ isset($data['privacy']) && $data['privacy'] == 1 ? '' : 'display:none;' }}">{{ translate('Privacy_Policy') }}</a>
                    <a href="#" id="refund-check"
                        style="{{ isset($data['refund']) && $data['refund'] == 1 ? '' : 'display:none;' }}">{{ translate('Refund_Policy') }}</a>
                    <a href="#" id="cancelation-check"
                        style="{{ isset($data['cancelation']) && $data['cancelation'] == 1 ? '' : 'display:none;' }}">{{ translate('Cancelation_Policy') }}</a>
                    <a href="#" id="contact-check"
                        style="{{ isset($data['contact']) && $data['contact'] == 1 ? '' : 'display:none;' }}">{{ translate('Contact_us') }}</a>
                </span>
                <span class="social" style="text-align:center">
                    <a href="#" id="facebook-check"
                        style="margin: 0 5px;text-decoration:none;{{ isset($data['facebook']) && $data['facebook'] == 1 ? '' : 'display:none;' }}">
                        <img src="{{ asset('/public/assets/admin/img/img/facebook.png') }}" alt="">
                    </a>
                    <a href="#" id="instagram-check"
                        style="margin: 0 5px;text-decoration:none;{{ isset($data['instagram']) && $data['instagram'] == 1 ? '' : 'display:none;' }}">
                        <img src="{{ asset('/public/assets/admin/img/img/instagram.png') }}" alt="">
                    </a>
                    <a href="#" id="twitter-check"
                        style="margin: 0 5px;text-decoration:none;{{ isset($data['twitter']) && $data['twitter'] == 1 ? '' : 'display:none;' }}">
                        <img src="{{ asset('/public/assets/admin/img/img/twitter.png') }}" alt="">
                    </a>
                    <a href="#" id="linkedin-check"
                        style="margin: 0 5px;text-decoration:none;{{ isset($data['linkedin']) && $data['linkedin'] == 1 ? '' : 'display:none;' }}">
                        <img src="{{ asset('/public/assets/admin/img/img/linkedin.png') }}" alt="">
                    </a>
                    <a href="#" id="pinterest-check"
                        style="margin: 0 5px;text-decoration:none;{{ isset($data['pinterest']) && $data['pinterest'] == 1 ? '' : 'display:none;' }}">
                        <img src="{{ asset('/public/assets/admin/img/img/pinterest.png') }}" alt="">
                    </a>
                </span>
                <span class="copyright" id="mail-copyright">
                    {{ $data['copyright_text'] ?? translate('Copyright_2023_ruchiCart._All_right_reserved') }}
                </span>
            </td>
        </tr>
    </tbody>
