    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            method="get" id="mail-status_form"></form>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.business-settings.email-setup.update', ['user', 'new-order']) }}"
                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-3">
                                            {{ translate('Logo') }} <span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Logo_must_be_1:1') }}">
                                                <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('show_hide_food_menu') }}">
                                            </span>
                                        </h5>
                                                ...
                                                <div class="col-sm-6">
                                                    @if ($language)
                                                        <div class="form-group m-0 lang_form default-form">
                                                            ...
                                                            <input type="text" maxlength="15" data-id="mail-button"
                                                                name="button_name[]"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="url" name="button_url"
                                                            ...
                                                            class="form-control" value="{{ $data['button_url'] ?? '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
