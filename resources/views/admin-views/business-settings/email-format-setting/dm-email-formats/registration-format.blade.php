    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                        ...
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                    data-original-title="{{ translate('If_a_Deliveryman_registers_from_the_Customer_app_or_Website,_Admin_Landing_Page_or_Restaurant_app,_he_will_get_a_Registration_Confirmation_email.') }}">
                ...
                <form action="{{ route('admin.business-settings.email-setup.update', ['dm', 'registration']) }}"
