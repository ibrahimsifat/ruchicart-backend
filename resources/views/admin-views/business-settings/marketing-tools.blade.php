        ...
        <div class="row gy-3">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.web-app.third-party.update-marketing-tools', ['meta']) : 'javascript:' }}"
                            method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meta_app_id"
                                    value="{{ isset($meta) ? $meta['meta_app_id'] : '' }}"
                                    placeholder="{{ translate('Enter Meta APP ID') }}">
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.web-app.third-party.update-marketing-tools', ['google']) : 'javascript:' }}"
                            method="post">
                            @csrf
                            <div class="d-flex justify-content-between gap-2 mb-5">
                                <h4 class="mb-0 d-flex gap-1 text-title fz-16">
                                ...
                                <div class="">
                                    ...
                                    <div class="text-start title-color mb-3">
                                        ...
                                        <p class="">
                                            ...
                                            Paste the ID to the Meta Pixel field in your ruchiCart Marketing Tool Page.
                                        </p>
                                    </div>
                                    <div class="text-start title-color mb-3">
                                        <h4 class="lh-md font-weight-bolder fz-16">
