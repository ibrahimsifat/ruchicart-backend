    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{ asset('public/assets/admin/img/icons/third-party.png') }}"
                    alt="">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <a class="btn-sm btn btn-outline-primary p-2 cursor-pointer" data-toggle="modal"
                ...
                <div class="badge-soft-secondary rounded my-5 p-3">
                    ...
                    <p class="m-0">
                        {{ translate('You must setup for V3 version. Otherwise the default reCAPTCHA will be displayed automatically') }}
                    </p>
                </div>
                    ...
                    <form
                        ...
                        <div class="d-flex flex-wrap mb-4 pl-1">
                            <label class="form-check form--check mr-2 mr-md-4">
                                <input class="form-check-input" type="radio" name="status" id="captcha_active"
                                    value="1" {{ isset($config) && $config['status'] == 1 ? 'checked' : '' }}>
                                <span class="mb-0">{{ translate('active') }}</span>
                            </label>
                            <label class="form-check form--check">
                                <input class="form-check-input" type="radio" name="status" id="captcha_inactive"
                ...
                <div class="modal-body">
                    ...
                    <ol class="d-flex flex-column __gap-5px __instructions">
                        <li>{{ translate('To get site key and secret key go to the Credentials page') }}
                            ({{ translate('Click') }} <a href="https://www.google.com/recaptcha/admin/create"
                        ...
                        <li>
                            ...
                            {{ translate('(For ex: demo.ruchicart.com)') }}
                        </li>
                        <li>
                            {{ translate('Check in ') }}
